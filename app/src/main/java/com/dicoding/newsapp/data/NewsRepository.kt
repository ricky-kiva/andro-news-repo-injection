...
class NewsRepository private constructor(
    ...
    // MediatorLiveData used to observe changes from multiple source (local & remote) then react to changes
    ...
    fun getHeadlineNews(): LiveData<Result<List<NewsEntity>>> {
        ...
        // 'addSource' acts as an observer for 'localData'
        // The 'Callback' will 'act when there is change'
